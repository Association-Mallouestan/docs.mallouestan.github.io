...
title: Huits noeuds de base
description: Apprendre les huit noeuds de base 
tags:
  - techniques
  - bindcraft
...
> De nombreuses liste de noeuds existe, celle ci as était construite autour de trois critères: simplicité d'apprentissage (que 5 noeuds a apprendre car les trois restant sont quasiment identiques), exhaustivité (répondent à 99% des situations), adaptabilité (des nœuds rapide, facile à défaire et d'autres nœuds reconnue comme faisant partie des plus fiables existants).

Avant de commencer à apprendre les noeuds, il est important de comprendre quelques concepts de base et d'avoir un vocabulaire commun pour pouvoir les décrire et les manipuler. Nous vous conseillons de lire [le vocabulaire et les bases du bindcraft](./bindcraft-vocabulaires-et-bases) avant de continuer avec les noeuds.

Il nous faut aussi présenté quelques informations suplémentaire notamment les cathégories de noeuds suivantes :
...
> Le cabestan sur la photo entourant la ganse de droite est l'étape finale une fois la corde tendu. Elle sert a bloquer la charge ou la tension.
...
Cette liste de noeuds n'est pas exhaustive, il existe de nombreux autres noeuds qui peuvent être utiles dans différentes situations. Cependant, ces huit noeuds sont parmi les plus couramment utilisés et devraient couvrir la plupart des besoins en matière de gestion de corde. Nous vous encourageons à pratiquer ces noeuds régulièrement pour les maîtriser et à explorer d'autres noeuds au fur et à mesure que vous gagnez en confiance. 
