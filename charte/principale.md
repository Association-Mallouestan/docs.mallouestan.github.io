...
3. **Porter une convivialité matérialiste non-libérale** (plus de détails dans le texte ["Une convivialité matérialiste non libérale"](https://www.mallouestan.org/r/philosophie-objectifs-convivialite))
4. **Adopter une vie saine et enviable** (plus de détails dans le texte ["Vie saine et enviable"](https://www.mallouestan.org/r/philosophie-objectifs-vie-saine-et-enviable))
5. **Développer un lieu de recherche et de transmission** (plus de détails dans le texte ["Recherche et transmission"](https://www.mallouestan.org/r/philosophie-objectifs-recherche-transmission))
6. **Investir une culture alternative et une vie culturelle** (plus de détails dans le texte ["Une culture et une vie culturelle"](https://www.mallouestan.org/r/philosophie-objectifs-culturel))
7. **Cohabiter avec le sauvage** (plus de détails dans le texte ["Une cohabitation avec le sauvage"](https://www.mallouestan.org/r/philosophie-objectifs-une-cohabitation-avec-le-sauvage))
...
1. Minimiser la violence ce qui implique:
	...
	- De minimiser les rapports de domestication et de violence à l'égard des animaux (sauvages comme domestiques ainsi qu'humains).
	- De respecter les limites explicitement exprimées par une personne tant qu'elles restent compatibles avec le fonctionnement du collectif. 
...
> Certains changements suite à des discussions collectives peuvent être mis en "attente" le temps que le processus décisionnel soit finalisé et peuvent être trouvés dans l'annexe [Annexe: décisions en attente](/r/charte-annexe-decisions-en-attente).
