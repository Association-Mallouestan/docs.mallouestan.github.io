...
1. L'écocentrisme est une approche où la valeur morale intrinsèque est accordé aux ecosystèmes et non: au "vivant" dans le cas du biocentrisme; des animaux (souvent sentient) dans le cas de l'antispécisme; uniquement des humains dans le cas de l'humanisme. Accordé une valeur intrinsèque a une comunauté biotique ne nie en rien l'individualité de ses composants. Un renard est bien un individu qui evolue dans un écosystème avec des caracteristique et des interets personnelles.Ces derniers diffèrent des interets des autres individus de l'écosystème (des autres renards aussi). Ancré la valeur morale au niveau écosystèmiqe permet de s'assurer que les interets du renard ne priment pas defacto sur les autres composants.
2. 
